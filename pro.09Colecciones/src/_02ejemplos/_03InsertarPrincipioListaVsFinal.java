 ...
 * 
 */
public class _03InsertarPrincipioListaVsFinal {
	public static void main(String[] args) {
		ArrayList<Integer> principio = new ArrayList<>();
		ArrayList<Integer> fin = new ArrayList<>();
		
		//ArrayList Inserta al final de forma muy rapida
		...
		//Sin embargo le es muy costoso añadir al principio
