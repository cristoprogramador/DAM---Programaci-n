 ...
 * LinkedList ---> [2]->[7]->[3]->[4]
 * 
 * Al hacer busquedas de posición LinkedList realiza busquedas desde el 
 * principio o final de la lista, según sea mayor o menor la posición con
 * respecto a la mitad de la lista.
 * 
 */
public class _05AccederAPosicionArayVsLinked {
	...
	public static void main(String[] args) {
		...
		//ArrayList encuentra directamente la posición
		//por lo que el costo es siempre el mismo en tiempo y muy 
		//reducido.
		...
		System.out.println("Tiempo buscando posición");
		System.out.println(t2-t1);
		
		//Sin embargo con LinkedList al buscar una posición ha de empezar
		// desde el principio (o final segun este abajo o arriba de la mitad de lista)
